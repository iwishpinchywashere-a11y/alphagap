        ...
        <form onSubmit={handleSubmit} className="ag-glass p-6 space-y-4">
          ...
          <label className="flex items-start gap-2.5 cursor-pointer group">
            <input
              ...
              className="mt-0.5 h-4 w-4 flex-shrink-0 rounded border-white/[0.20] bg-white/[0.06] text-emerald-500 focus:ring-emerald-500 focus:ring-offset-gray-900"
            />
            <span className="text-xs text-gray-400 leading-relaxed">
              I have read and agree to the{" "}
              <Link href="/terms" target="_blank" className="text-emerald-400 hover:text-emerald-300 underline underline-offset-2 transition-colors">
...
export default function SignUpPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#07090b] ag-aurora flex items-center justify-center"><div className="text-emerald-400 animate-spin text-2xl">⟳</div></div>}>
      <SignUpForm />
    </Suspense>
  );
}
