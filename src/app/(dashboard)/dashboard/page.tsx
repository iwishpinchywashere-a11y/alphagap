...
const COLUMNS: [keyof SubnetScore, string, string][] = [
  ...
  ["eval_score", "eVal", "Emissions-to-Valuation (0-100). Finds the gap between what the network pays a subnet (emissions) vs what the market values it (market cap)."],
  ["social_score", "Social", "Social Velocity (0-100). Multi-source social intelligence: X/Twitter KOL mentions, Discord activity, and Stitch3 campaign scoring."],
