...
const COLUMNS: [keyof SubnetScore, string, string][] = [
  ...
  ["eval_score", "eVal", "Emissions & Network Health Score (0-100). Combines three layers: (1) Emissions-to-valuation ratio — how much the Bittensor network pays out to this subnet vs. what the market has priced in. (2) Validator & miner health — are validators actively setting weights, or are they stale/copying? Are miners being queried, or running on burn code? (3) Collusion risk — trust concentration across validators. High eVal = strong network conviction with a healthy operational layer the market hasn't priced in yet."],
