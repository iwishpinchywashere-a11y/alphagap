...
const SOCIAL = [
  ...
  {
    label: "Discord",
    href: "https://discord.com/invite/wSC49Gtjsy",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "Telegram",
    href: "https://t.me/beanstockcalls",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    <div className="flex items-center gap-2">
      {SOCIAL.map(({ label, href, icon }) => (
        <a
          ...
          title={label}
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-gray-500 hover:text-gray-200 hover:bg-gray-800 transition-colors text-xs"
        >
          {icon}
          <span>{label}</span>
        </a>
