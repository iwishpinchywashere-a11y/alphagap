...
export default function DashboardFooter() {
  ...
  return (
    <footer className="border-t border-white/[0.08] bg-white/[0.02] backdrop-blur-[14px] px-6 py-4 text-xs text-gray-600">
      {/* Disclaimer */}
      <div className="mb-3 text-xs text-gray-400 leading-relaxed max-w-4xl">
        ...
        <a href="/terms" className="text-emerald-400 hover:text-emerald-300 underline underline-offset-2 transition-colors whitespace-nowrap">Terms &amp; Privacy Policy</a>
      </div>
      {/* Bottom row */}
      <div className="flex flex-wrap items-center justify-between gap-3 font-mono text-[11px] text-gray-500">
