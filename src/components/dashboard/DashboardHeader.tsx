            ...
            <>
              ...
              <div className="py-1">
                ...
                <Link
                  href="/watchlist"
                  onClick={closeDropdown}
                  className="flex items-center gap-2.5 px-4 py-2.5 text-sm font-bold text-blue-400 hover:bg-blue-900/20 hover:text-blue-300 transition-colors"
                >
                ...
                {isActive && (
                  <Link
                    href="/write-review"
                    onClick={closeDropdown}
                    className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-yellow-400 hover:bg-yellow-500/10 hover:text-yellow-300 transition-colors"
                  >
