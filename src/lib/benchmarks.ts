...
export const BENCHMARK_DATA: BenchmarkEntry[] = [
  ...
  },
  {
    ...
    subnet_name: "It's AI",
    benchmark_score: 78,
    benchmark_category: "AI Content Detection",
    vs_provider: "GPTZero / Originality.ai / CopyLeaks",
    cost_saving_pct: 65,
    perf_delta: "#1 MGTD benchmark (ICAIE 2025), 92%+ ROC-AUC",
  ...
  },
  {
    ...
    benchmark_score: 82,
    benchmark_category: "Physical AI / Autonomous Driving Data",
    vs_provider: "HERE Maps HD / Google Immersive View / TomTom",
    cost_saving_pct: 85,
    perf_delta: "250K+ contributors vs centralized teams; 170M+ km mapped",
  ...
  // ── APRIL 2026 RESEARCH SWEEP — 43 NEW ENTRIES ───────────────────
  {
    ...
    benchmark_score: 76,
    benchmark_category: "Prediction Market Intelligence",
    vs_provider: "Polymarket manual traders / Metaculus / Manifold Markets",
    cost_saving_pct: 0,
    perf_delta: "178% monthly ROI Feb 2025; 350+ live Polymarket trades",
  ...
  },
  {
    ...
    benchmark_score: 74,
    benchmark_category: "AI Voice / Speech Synthesis",
    vs_provider: "ElevenLabs / Google TTS / Hume AI",
    cost_saving_pct: 70,
    perf_delta: "Empathetic voice models for AI companions; 8.6M user app",
  ...
  },
  {
    ...
    benchmark_score: 75,
    benchmark_category: "Social & Web Data",
    vs_provider: "Brandwatch / Bright Data / Diffbot / Sprinklr",
    cost_saving_pct: 80,
    perf_delta: "55B+ rows — 10.79% of all Hugging Face datasets; paying customers",
  ...
  },
  {
    ...
    benchmark_score: 70,
    benchmark_category: "AI Forecasting / Prediction Intelligence",
    vs_provider: "Metaculus / Polymarket aggregators / Superforecaster platforms",
    cost_saving_pct: 60,
    perf_delta: "Superhuman prediction ensemble; Nous Research $50M/Paradigm ecosystem",
  ...
  },
  {
    ...
    benchmark_score: 68,
    benchmark_category: "AI Coding Assistants",
    vs_provider: "GitHub Copilot / Cursor / Tabnine",
    cost_saving_pct: 80,
    perf_delta: "Competitive benchmarking across Bittensor miners; subscription live",
  ...
  },
  {
    ...
    benchmark_score: 66,
    benchmark_category: "Web3 Due Diligence / Ratings",
    vs_provider: "S&P Global / Moody's / Messari Research",
    cost_saving_pct: 90,
    perf_delta: "$1.15M Lamida Crypto investment; 40-page tamper-proof rating methodology",
  ...
  },
  {
    ...
    benchmark_score: 67,
    benchmark_category: "Identity Verification / KYC Security",
    vs_provider: "Jumio / Onfido / Socure adversarial testing tools",
    cost_saving_pct: 85,
    perf_delta: "$900K oversubscribed seed; adversarial KYC dataset generation for banks",
  ...
  },
  {
    ...
    benchmark_score: 70,
    benchmark_category: "Semiconductor Design",
    vs_provider: "ARM / Cadence / Synopsys design flows",
    cost_saving_pct: 95,
    perf_delta: "RISC-V + crypto extensions completed; path to real silicon via Google OpenMPW",
  ...
  },
  {
    ...
    benchmark_score: 66,
    benchmark_category: "Enterprise AI Inference",
    vs_provider: "CoreWeave / AWS SageMaker / Modal",
    cost_saving_pct: 75,
    perf_delta: "110%+ token surge at launch; Jack Clark (Anthropic co-founder) signal",
  ...
  },
  {
    ...
    benchmark_score: 70,
    benchmark_category: "AI 3D Generation",
    vs_provider: "Luma AI / Meshy / Stability AI 3D / Masterpiece Studio",
    cost_saving_pct: 90,
    perf_delta: "21.5M+ AI-generated 3D models — world's largest open-source 3D dataset",
  ...
  {
    subnet_id: 39,
    subnet_name: "EdgeMaxxing (WOMBO)",
    benchmark_score: 68,
    benchmark_category: "Edge AI / On-Device Inference",
    vs_provider: "Apple Core ML / ONNX Runtime / TensorRT",
    cost_saving_pct: 0,
    perf_delta: "Daily model optimization competition; WOMBO Dream team (200M+ downloads)",
    benchmark_summary: "EdgeMaxxing (SN39) is a daily AI model optimization competition — miners optimize Stable Diffusion XL and Flux Schnell for consumer-grade hardware (RTX 4090 and below). Winners selected on speed improvement + accuracy retention. Built by WOMBO — creators of WOMBO Dream (200M+ downloads, #1 in 100+ countries). MIT-licensed open source. Targets the $100B+ edge AI / on-device inference market projected by 2030 (Gartner). Continuously produces the best open-source optimized AI models for consumer hardware.",
    active_users: "Consumer GPU owners + developers",
    annual_revenue_usd: 0,
    last_updated: "2026-04-07",
    sources: ["https://github.com/womboai/edge-maxxing"],
  },
  {
    subnet_id: 24,
    subnet_name: "OMEGA Labs",
    benchmark_score: 66,
    benchmark_category: "AI Training Data / Computer-Use Agents",
    vs_provider: "Scale AI / Appen / HumanSignal / Labelbox",
    cost_saving_pct: 80,
    perf_delta: "Building training data for computer-use AI agents; Hugging Face dataset live",
  ...
  },
  {
    ...
    benchmark_score: 65,
    benchmark_category: "DDoS Protection / Network Security",
    vs_provider: "Cloudflare / Akamai / Fastly / AWS Shield",
    cost_saving_pct: 85,
    perf_delta: "eBPF/XDP-based filtering nodes OSI L3-7; ML anomaly detection; MEXC listed",
  ...
  },
  {
    ...
    benchmark_score: 65,
    benchmark_category: "Cybersecurity / Red Teaming",
    vs_provider: "HackerOne / Bugcrowd / Synack Red Team",
    cost_saving_pct: 80,
    perf_delta: "Gamified decentralized exploit submission; Innerworks bot detection specialists",
  ...
  },
  {
    ...
    benchmark_score: 64,
    benchmark_category: "Fact Verification / Content Trust",
    vs_provider: "NewsGuard / Google Fact Check / Snopes enterprise",
    cost_saving_pct: 85,
    perf_delta: "Semantic fact verification at scale; prediction market app beta live; Yuma-accelerated",
  ...
  },
  {
    ...
    benchmark_score: 64,
    benchmark_category: "Robotics AI / Simulation",
    vs_provider: "NVIDIA Isaac Lab / Boston Dynamics sim tools / Mujoco",
    cost_saving_pct: 0,
    perf_delta: "First decentralized robotics policy competition on NVIDIA Omniverse/Isaac Sim",
  ...
  },
  {
    ...
    benchmark_score: 65,
    benchmark_category: "Real Estate AI / Proptech",
    vs_provider: "Zillow Zestimate / Redfin Estimate / CoreLogic",
    cost_saving_pct: 90,
    perf_delta: "Claims to outperform Zillow on accuracy; Nickel5 team (Almanac/Sportstensor)",
  ...
  },
  {
    ...
    benchmark_score: 60,
    benchmark_category: "AI Agents / Robotics Cognition",
    vs_provider: "Langchain memory / OpenAI Assistants API / mem0",
    cost_saving_pct: 75,
    perf_delta: "Persistent memory + ethical reasoning modules for AI agents; Yuma-accelerated",
  ...
  },
  {
    ...
    benchmark_score: 60,
    benchmark_category: "Web Automation / RPA",
    vs_provider: "UiPath / Automation Anywhere / Make.com",
    cost_saving_pct: 85,
    perf_delta: "Adaptive AI agents that don't break on UI changes; fully permissionless",
  ...
  },
  {
    ...
    benchmark_score: 63,
    benchmark_category: "AI Alignment / LLM Fine-Tuning",
    vs_provider: "OpenAI fine-tuning API / Hugging Face AutoTrain / Together AI finetuning",
    cost_saving_pct: 80,
    perf_delta: "LLM finetuning + AI hallucination stress-testing; Macrocosmos + Taoverse",
  ...
  },
  {
    ...
    benchmark_score: 65,
    benchmark_category: "Distributed AI Training",
    vs_provider: "CoreWeave / Lambda Labs / RunPod LLM training",
    cost_saving_pct: 90,
    perf_delta: "Distributed LLM pretraining on consumer hardware; Train at Home MacBook app launched",
  ...
  },
  {
    ...
    benchmark_score: 62,
    benchmark_category: "LLM Inference API",
    vs_provider: "OpenAI API / Anthropic API / Together AI",
    cost_saving_pct: 85,
    perf_delta: "Competitive inference routing across LLMs; chat completions + web retrieval API",
  ...
  },
  {
    ...
    benchmark_score: 66,
    benchmark_category: "AutoML / Neural Architecture Search",
    vs_provider: "Google AutoML / AWS SageMaker AutoML / Microsoft NNI",
    cost_saving_pct: 90,
    perf_delta: "Beat Google NAS solvers on CIFAR-10; 2-4% accuracy gain over SOTA at same param count",
  ...
  },
  {
    ...
    benchmark_score: 58,
    benchmark_category: "Open Source Developer Incentives",
    vs_provider: "GitHub Sponsors / Gitcoin / Open Collective",
    cost_saving_pct: 0,
    perf_delta: "Cryptographic incentives for merged open-source PRs; GitHub-native workflow",
  ...
  },
  {
    ...
    benchmark_score: 63,
    benchmark_category: "Scientific Compute / Drug Discovery",
    vs_provider: "Schrödinger / OpenEye / AWS Life Sciences / Folding@home",
    cost_saving_pct: 85,
    perf_delta: "Protein folding + ligand docking API; Rowan Scientific partnership for NNP development",
  ...
  },
  {
    ...
    benchmark_score: 55,
    benchmark_category: "Text Embeddings / Semantic Search",
    vs_provider: "OpenAI Embeddings / Cohere / Voyage AI",
    cost_saving_pct: 75,
    perf_delta: "Competitive embedding model marketplace; Kaito AI Polymarket 'Attention Markets' pivot",
  ...
  },
  {
    ...
    benchmark_score: 57,
    benchmark_category: "DeFi AI Intelligence",
    vs_provider: "Nansen / Dune Analytics / Messari Research",
    cost_saving_pct: 80,
    perf_delta: "Berkeley Function Calling Leaderboard competition; 230% token appreciation",
  ...
  },
  {
    ...
    benchmark_score: 62,
    benchmark_category: "Financial Data Oracles",
    vs_provider: "Chainlink price feeds / Pyth Network / Bloomberg B-PIPE",
    cost_saving_pct: 80,
    perf_delta: "Institutional operator (Foundry Digital/DCG); 5-min prediction cycles during market hours",
  ...
  },
  {
    ...
    benchmark_score: 62,
    benchmark_category: "Crypto Price Intelligence",
    vs_provider: "Coin Metrics / Kaiko / CryptoCompare enterprise feeds",
    cost_saving_pct: 80,
    perf_delta: "BTC price forecast every 5 min (1hr ahead); simulated positive returns vs buy-and-hold",
  ...
  },
  {
    ...
    subnet_name: "BitAds",
    benchmark_score: 60,
    benchmark_category: "Performance Advertising",
  ...
  },
  {
    ...
    benchmark_score: 55,
    benchmark_category: "AI Agents / Enterprise IT Automation",
  ...
  },
  {
    ...
    subnet_name: "Nuance",
    benchmark_score: 52,
    benchmark_category: "Content Quality / Trust & Safety",
    vs_provider: "Jigsaw (Google) / NewsGuard / Community Notes (X)",
    cost_saving_pct: 85,
    perf_delta: "Financial incentives for quality discourse; 400K+ Sybil-protected evaluator accounts",
  ...
  },
  {
    ...
    subnet_name: "Storb",
    benchmark_score: 48,
    benchmark_category: "Decentralized Object Storage",
    vs_provider: "AWS S3 / Google Cloud Storage / Filecoin",
    cost_saving_pct: 85,
    perf_delta: "Erasure coding + Bittensor incentives; up to 256 nodes (64 validators, 192 miners)",
  ...
  },
  {
    ...
    benchmark_score: 50,
    benchmark_category: "Combinatorial Optimization / Algo Trading",
    vs_provider: "Google OR-Tools / IBM CPLEX / Gurobi",
    cost_saving_pct: 70,
    perf_delta: "7% routing efficiency gain on TSP; TaoTrader copy-trading platform in development",
  ...
  },
  {
    ...
    benchmark_score: 48,
    benchmark_category: "LLM Token Compression",
    vs_provider: "LLMLingua / KVCache optimization / Selective Context",
    cost_saving_pct: 40,
    perf_delta: "35-45% token compression, 90% accuracy retention; NOTE: listed as 'FOR SALE'",
  ...
  },
  {
    ...
    benchmark_score: 52,
    benchmark_category: "Quantum Computing Simulation",
  ...
  },
  {
    ...
    subnet_name: "Oceans",
    benchmark_score: 48,
    benchmark_category: "DeFi Liquidity Infrastructure",
    vs_provider: "Uniswap LP management / Gamma Strategies / Arrakis Finance",
    cost_saving_pct: 60,
    perf_delta: "Governance-directed concentrated LP for Bittensor subnet token pools",
  ...
  },
  {
    ...
    subnet_name: "Tenex",
    benchmark_score: 44,
    benchmark_category: "Leveraged Trading / DeFi Derivatives",
    vs_provider: "dYdX / GMX / Hyperliquid (for Bittensor alpha tokens)",
    cost_saving_pct: 0,
    perf_delta: "Long-only leveraged TAO collateral protocol for Bittensor subnet tokens",
  ...
  },
  {
    ...
    benchmark_score: 50,
    benchmark_category: "Bittensor DeFi / OTC Trading",
    vs_provider: "OTC desks / Paraswap / CoW Protocol",
    cost_saving_pct: 60,
    perf_delta: "Dutch auction OTC for subnet alpha tokens; cross-subnet treasury yield generation",
  ...
  },
  {
    ...
    benchmark_score: 44,
    benchmark_category: "DeFi Liquidity Mining",
    vs_provider: "Convex Finance / Curve / Balancer gauge system",
    cost_saving_pct: 0,
    perf_delta: "Governance-directed LP rewards for Bittensor subnet tokens in external DeFi markets",
  ...
  },
  {
    ...
    benchmark_score: 54,
    benchmark_category: "Synthetic Financial Data / Quant Finance",
    vs_provider: "QuantConnect / Numerai / Refinitiv synthetic data",
    cost_saving_pct: 80,
    perf_delta: "Agent-based trading simulations; synthetic financial dataset generation",
  ...
  },
  {
    ...
    benchmark_score: 42,
    benchmark_category: "AI Marketplace / Model Generation",
    vs_provider: "Hugging Face Hub / Replicate / fal.ai",
    cost_saving_pct: 70,
    perf_delta: "AI models generating and validating other AI outputs; 'one-stop hub' for Bittensor marketplaces",
  ...
  },
  {
    ...
    benchmark_score: 52,
    benchmark_category: "Graph Optimization / Combinatorial AI",
    vs_provider: "IBM CPLEX / Gurobi / Google OR-Tools (clique solvers)",
    cost_saving_pct: 80,
    perf_delta: "Distributed NP-hard maximum clique solving; rewards algorithmic novelty not just best result",
  ...
  },
  {
    ...
    subnet_name: "MIAOAI",
    benchmark_score: 50,
    benchmark_category: "E-Commerce AI / Customer Service",
    vs_provider: "Zendesk AI / Intercom / Tidio / Freshdesk",
    cost_saving_pct: 85,
    perf_delta: "Lucky Cat e-commerce AI; Alibaba dialogue training data; multilingual",
  ...
  },
  {
    ...
    benchmark_score: 52,
    benchmark_category: "Generative AI / Interactive Narrative",
    vs_provider: "Inworld AI / KoboldAI / Novel AI / GPT-4 story generation",
    cost_saving_pct: 80,
    perf_delta: "Structured narrative pipeline (Blueprint→Characters→Arc→Chapters); game developer API",
  ...
  },
  {
    ...
    benchmark_score: 56,
    benchmark_category: "AutoML / AI Research",
    vs_provider: "Google AutoML / OpenAI research evals / MLflow",
    cost_saving_pct: 90,
    perf_delta: "90% emissions burned unless genuine SOTA proved; genetic programming ML evolution",
...
export const PRODUCT_MILESTONES: ProductMilestone[] = [
  ...
  },
  {
    ...
    stage: "live",
    milestone_date: "2025-01-01",
    title: "Consumer GPU AI optimization — daily benchmark competition, Flux Schnell on RTX 4090, WOMBO team",
    description: "EdgeMaxxing (SN39) is a daily AI model optimization competition where miners optimize state-of-the-art models (Stable Diffusion XL, Flux Schnell) for consumer-grade hardware (NVIDIA RTX 4090 and below). Winners selected on speed improvement + accuracy retention. Built by WOMBO — creators of WOMBO Dream (200M+ downloads, #1 in 100+ countries). Targets the $100B+ edge AI/on-device inference market projected by 2030 (Gartner). MIT-licensed open source. GitHub: womboai/edge-maxxing.",
    source_url: "https://github.com/womboai/edge-maxxing",
    estimated_arr_usd: 0,
    confidence: "high",
  },
  {
