...
export const BENCHMARK_DATA: BenchmarkEntry[] = [
  ...
  // ── NEW ENTRIES — Subnets with first-party live dashboards ──────────────
  {
    ...
    benchmark_summary: "Taoshi's Proprietary Trading Network (SN8) aggregates competing AI trading strategies into a decentralized hedge fund layer. Miners submit positions across crypto, forex, and equities — validators score on risk-adjusted returns. Vanta Trading prop firm officially launched February 17, 2026 — evaluation tiers: $25K/$50K/$100K simulated accounts at $199/$349/$549; 100% profit split on pass. $30M+ paid out to traders (lifetime). GlitchFinancial automated trading (beta) and 0x_Markets DEX also launched. $20B+ traditional prop trading industry TAM.",
