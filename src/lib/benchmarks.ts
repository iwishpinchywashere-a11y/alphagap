...
export const BENCHMARK_DATA: BenchmarkEntry[] = [
  {
    ...
    benchmark_summary: "85% cheaper than AWS Lambda; 10x faster startup (200ms vs 2s+); peaked at ~120B tokens/day (~1/3 of Google NLP throughput); 400K+ users; 9.1T tokens processed. #1 provider on OpenRouter by traffic volume. Fiat payments launched (beta, credit card accepted). Llama 4 models added. TaonSquare AI App Directory integration. Part of Rayon Labs trio (SN19 + SN56 + SN64) controlling ~23.7% of network emissions.",
    active_users: "400K+",
  ...
  },
  {
    ...
    benchmark_summary: "AI coding assistant with Cursor/VS Code extension at $12/month. Merged with Latent Holdings in February 2026 (combining Ridges' subnet expertise with Latent's go-to-market capabilities). SWE-bench score previously cited at 66-69% — methodology has since changed significantly with Polyglot evaluation; current score ~41%. Revenue: taorevenue.com shows a deficit vs. emissions (external revenue unconfirmed for 2026). Investors: Stillcore Capital, DSV Fund. Watch for post-merger commercialization results.",
  ...
  },
  {
    ...
    benchmark_summary: "5.14M+ combined subscriber/follower network across YouTube and Stitch3 (X). ~$630K worth of SN93 alpha tokens burned (18% of issued supply). Bitget (crypto exchange) confirmed as paying brand client. Performance-based model: brands pay only for verified reach. YouTube audience grew 66% in April 2026. X expansion underway. New roadmap May 2026 with self-serve advertiser portal and fiat payment support. Decentralized content marketing protocol on Bittensor — brands post briefs on-chain, creators (miners) produce YouTube and X/Twitter content, validators score against briefs using YouTube OAuth API. Weekly on-chain buybacks burning SN93 alpha tokens from revenue — active deflationary flywheel. Listed on Bybit, Crypto.com, MEXC. $20-25B global influencer marketing TAM.",
  ...
  },
  {
    ...
    benchmark_summary: "Score's Manako platform processes a full 90-min football match in ~2 min for ~$10 vs $10,000+ with manual annotation (99%+ cost reduction). PwC France & Maghreb alliance announced April 15, 2026 — Manako integrated into PwC's AI advisory practice across 136 countries (retail, logistics, manufacturing, energy). Won 1st place Paris Blockchain Week Start In Block 2026 (beat 1,000+ startups, judged by Bybit, Nethermind, Ribbit Capital). 94% per-frame accuracy on SoccerNet GSR challenge. Enterprise clients: Reading FC (tactical analytics), major European petroleum company (gas station CCTV), $5B sports betting syndicate (20% revenue share). 100% trial-to-paid conversion rate. 20% of all commercial revenue directed to SN44 alpha buybacks.",
    active_users: "4+ enterprise clients",
    annual_revenue_usd: 360000,
    last_updated: "2026-05-15",
    sources: [
  ...
  },
  {
    ...
    benchmark_summary: "ChipForge (SN84) is the world's first decentralized hardware design subnet — miners design real silicon chips using Verilog/SystemVerilog evaluated by automated EDA tools on functionality, area, timing, and power. Community delivered a complete 32-bit RISC-V CPU (RV32IMCK) with AES and SHA cryptographic extensions — synthesizable RTL code with measured PPA metrics (real engineering output). Preparing for Google OpenMPW shuttle submission for actual silicon fabrication. 2026-2027 roadmap: expand into compiler and AI kernel optimization (hardware/software co-design). Post-quantum encryption extensions planned. Covered by CoinPedia, CryptoPaper, U.Today. Addresses the $600B+ semiconductor market — chip design tools alone ~$12B.",
  ...
  },
  {
    ...
    benchmark_score: 72,
    benchmark_category: "Data & Intelligence",
    vs_provider: "Google Shopping AI / Amazon Rufus / Perplexity Shopping",
    cost_saving_pct: 70,
    perf_delta: "#1 30-day TAO inflow on taorevenue.com ($607K/month) — AI shopping agents outperform GPT-5.4 on complex purchases",
    benchmark_summary: "ORO (SN15) is a decentralized evaluation network for AI shopping agents — miners submit Python-coded agents that search real products, compare prices, and make purchase decisions; validators run agents in sandboxed Docker environments against ShoppingBench (2.5M real products). ORO outperformed OpenAI GPT-5.4 on complex shopping evaluations. Highest 30-day TAO inflow tracked on taorevenue.com at 2,112τ ($607K/month) — highest of any Bittensor subnet. Launched production-ready Bittensor auth stack (April 21, 2026): SR25519 signature verification, metagraph caching, nonce replay protection. Backed by Crucible Labs, Unsupervised Capital, Savant. Consumer shopping assistant planned for future phase.",
    active_users: "AI agent developers + e-commerce platforms",
    annual_revenue_usd: 0,
    last_updated: "2026-05-15",
    sources: [
      "https://oroagents.com/",
  ...
  // ── NEW ENTRIES — Subnets with first-party live dashboards ──────────────
  {
    ...
    benchmark_summary: "Vanta (SN8) by Taoshi is the world's first hyperscaled decentralized prop firm — powered by Bittensor AI trading intelligence and settled on Hyperliquid's perp DEX. Their flagship product, Hyperscaled, is a 1-step funded account challenge: 10% profit target, 5% max drawdown, 100% profit split paid monthly in USDC directly to wallet. No take fees, no time limit, no withdrawal delays — all rules and payouts are verifiable on-chain. Funded accounts scale from $25K to $400K ($2.5M roadmap). $30M+ paid out to traders to date. Beats every major centralized prop firm on profit split (industry standard: 70–80%), evaluation structure (1-step vs 2-phase), and payout trust (automatic on-chain vs discretionary). Competes in the $20B+ global prop trading industry. Additional products: VantaTrading (core evaluation platform), GlitchFinancial (automated trading beta), 0x_Markets (DEX for crypto, forex, commodities).",
  ...
  {
    subnet_id: 27,
    subnet_name: "Nodexo (Neural Internet)",
    benchmark_score: 77,
    benchmark_category: "AI Compute",
    vs_provider: "CoreWeave / Vast.ai / RunPod",
    cost_saving_pct: 80,
    perf_delta: "H100/A100 GPUs from $0.37/hr — first revenue-generating Bittensor subnet",
    benchmark_summary: "Nodexo (rebranded from NI Compute / Neural Internet, SN27) is a decentralized GPU compute marketplace — the first revenue-generating subnet on Bittensor. Miners provide NVIDIA H100, A100, and L40S GPUs available for instant deployment. H200 GPUs earn 3x reward multiplier. 2,940.7 TFLOPS tracked. 8-GPU-per-miner support coming. Model inference endpoint service announced for Q4 2026. New dashboard significantly improved UX. Being outcompeted on pure compute by lium (SN51) — Nodexo differentiating on marketplace UX and inference endpoints.",
  ...
  {
    subnet_id: 53,
    subnet_name: "Efficient Frontier (SignalPlus)",
    benchmark_score: 66,
    benchmark_category: "Finance & Trading",
    vs_provider: "Deribit Analytics / GSR Markets / Proprietary Quant Desks",
    cost_saving_pct: 70,
    perf_delta: "$70M+ PnL generated by subnet strategies — live crypto trading data via SignalPlus",
    benchmark_summary: "Efficient Frontier (SN53) by SignalPlus optimizes crypto trading strategies using decentralized ML and live trading data. Miners submit strategies scored on exponentially weighted daily returns relative to rolling 14-day peak-to-trough drawdown. SignalPlus (est. 2021) acts as trusted intermediary verifying trading data via deep exchange integration. Partner: SOFA.org. '$70M+ PnL generated' by subnet strategies (claimed). First Bittensor subnet focused on real-market trading with live exchange data verification. New strategies require a 14-day observation period before full scoring. Addresses the institutional crypto quant strategy market.",
    active_users: "Crypto quant traders",
    annual_revenue_usd: 0,
    last_updated: "2026-05-15",
    sources: [
      "https://subnetalpha.ai/subnet/efficient_frontier/",
    ],
  },
  {
    subnet_id: 97,
    ...
    benchmark_score: 52,
    benchmark_category: "AI Training",
    vs_provider: "Hugging Face distillation pipelines / Internal lab model compression teams",
    cost_saving_pct: 75,
    perf_delta: "Student models ≤5.25B params from 35B teacher — 60-80% inference cost reduction downstream",
    benchmark_summary: "Distil (SN97) is a competitive model distillation subnet by Arbos. Miners take a 35B parameter teacher model (Qwen3.5-35B-A3B loaded via vLLM), draw 120 prompts from ClimbMix-400B (seeded by on-chain block hash), and must produce a ≤5.25B parameter student model minimizing KL divergence from the teacher. Models ranked across 25+ capability axes. KL > 2.0 disqualifies. Dethronement requires paired t-test at p < 0.05 — rigorous statistical standards. Winner-takes-all emission model. Smaller distilled models mean 60-80% inference cost reduction for downstream API users. Website: distil.arbos.life",
    active_users: "ML researchers + open-source contributors",
    annual_revenue_usd: 0,
    last_updated: "2026-05-15",
    sources: [
  ...
  },
  {
    ...
    benchmark_score: 45,
    benchmark_category: "Developer Tools",
    vs_provider: "Mem0 / Letta / Zep / OpenAI Assistants API memory",
    cost_saving_pct: 60,
    perf_delta: "Persistent cross-session memory for AI agents — decentralized alternative to Mem0/Letta",
    benchmark_summary: "Ditto (SN118) by Omni Aura is a shared long-term memory and context layer for AI agents on Bittensor. Miners store, index, and serve persistent memory states that AI agents can query across sessions — solving the core statelessness problem of multi-session agentic workflows. Directly competitive with Mem0, Letta, and Zep. As agentic AI dominates the 2026 landscape, persistent memory infrastructure is a fundamental missing layer. Pre-revenue, early stage, but strategically timed with the agentic AI wave.",
    active_users: "AI agent developers",
    annual_revenue_usd: 0,
    last_updated: "2026-05-15",
    sources: [
