...
export const BENCHMARK_DATA: BenchmarkEntry[] = [
  ...
  },
  {
    ...
    benchmark_summary: "NATIX StreetVision (SN72) is a decentralized physical AI subnet ingesting real-world street imagery from 250,000+ contributors via the Drive& app and VX360 dashcam to train computer vision models for autonomous driving and HD mapping. 170M+ km already mapped. Built in partnership with Grab. 85% cheaper than centralized HD mapping approaches. Launched Bittensor mainnet May 2025. No confirmed external customer revenue figure publicly disclosed as of May 2026 — subnet too early stage. Revenue from data sales to automotive/mapping clients is described in roadmap but no dollar figure has been published.",
