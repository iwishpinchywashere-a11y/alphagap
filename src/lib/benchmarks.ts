...
export const BENCHMARK_DATA: BenchmarkEntry[] = [
  ...
  },
  {
    ...
    cost_saving_pct: 70,
    perf_delta: "72B-param LLM trained decentralized — GPT-4 class benchmarks",
  ...
  },
  {
    ...
    cost_saving_pct: 65,
    perf_delta: "$1,200+ CPM vs $50–100 centralized — crypto-native creator payouts",
  ...
  },
  {
    ...
    cost_saving_pct: 0,
    perf_delta: "Daily on-device model optimization — WOMBO Dream team (200M+ downloads)",
